...
init_ruby_module()
{
  ...
  char CV_VERSION[] = "2.4.3";
  int CV_VERSION_EPOCH = 2;
  int CV_VERSION_MAJOR = 4;
  int CV_VERSION_MINOR = 3;
  int CV_VERSION_REVISION = 0;
  int CV_MAJOR_VERSION = 2;
  int CV_MINOR_VERSION = 4;
  int CV_SUBMINOR_VERSION = 3;
